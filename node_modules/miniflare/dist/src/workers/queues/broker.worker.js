...
var QueueMessageDelaySchema = z.number().int().min(0).max(86400).optional(), QueueProducerOptionsSchema = /* @__PURE__ */ z.object({
...
), QueueProducersSchema = /* @__PURE__ */ z.record(
  z.string(),
  QueueProducerSchema
), QueueConsumerOptionsSchema = /* @__PURE__ */ z.object({
  ...
  z.object({ workerName: z.string() })
), QueueConsumersSchema = /* @__PURE__ */ z.record(
  z.string(),
  QueueConsumerSchema
), QueueContentTypeSchema = /* @__PURE__ */ z.enum(["text", "json", "bytes", "v8"]).default("v8"), QueueIncomingMessageSchema = /* @__PURE__ */ z.object({
