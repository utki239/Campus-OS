 ...
 */
interface WorkflowExport extends Pick<WorkflowBinding, "limits" | "concurrency" | "schedules" | "default_retention"> {
    type: "workflow";
    name: string;
}
type ConfiguredExport = DurableObjectExport | WorkerEntrypointExport | WorkflowExport;
/**
...
type TcpConnectHandlerConfig = ConnectHandlerConfigBase & {
    protocol: "tcp";
};
